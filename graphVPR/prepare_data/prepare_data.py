...
def prep_building_level_localization(scene_names):
...
#    out = args.output_path
    ...
    inp = '/home/shubodh/catkin_ws_all/catkin_ws_xview/src/x-view-scratch-not-catkin/x-view-scratch/data_collection/x-view/mp3d/'
    out = '../../datasets/graphVPR/building_level_localization/'
    ...
    for scene_id, scene in enumerate(scene_names):
        print(f"Extracting for scene no. {scene_id}, scene name: {scene} and room: ")
...
def write_pair_txt_room_level_localization(folder_name, scene_names, output_txt):
    # writes pairs txt files given folder names
...
if __name__ == '__main__':
   ...
   "yqstnuAEVhm"
    ...
    output_txts = [
    '../../pairs/graphVPR/room_level_localization_small/pairs-0_mp3d_8WUmhLawc2A.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-1_mp3d_EDJbREhghzL.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-2_mp3d_i5noydFURQK.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-3_mp3d_jh4fc5c5qoQ.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-4_mp3d_mJXqzFtmKg4.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-5_mp3d_qoiz87JEwZ2.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-6_mp3d_RPmz2sHmrrY.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-7_mp3d_S9hNv5qa7GM.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-8_mp3d_ULsKaCPVFJR.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-9_mp3d_VzqfbhrpDEA.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-10_mp3d_wc2JMjhGNzB.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-11_mp3d_WYY7iVyf5p8.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-12_mp3d_X7HyMhZNoso.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-13_mp3d_YFuZgdQ5vWj.txt',
    '../../pairs/graphVPR/room_level_localization_small/pairs-14_mp3d_yqstnuAEVhm.txt'
    ]
    ...
    #prep_building_level_localization(scene_names)

    # 2nd function: Write pair txt files

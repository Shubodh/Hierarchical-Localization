...
if __name__ == '__main__':
    ...
    for scene_type in current_scene_types:
        ...
        for room_id in room_ids:
            ...
            print("python3 pipeline_InLoc_metric_level_ADA_RIO10-data_NETVLAD_ALL_idea6.py --scene_type " +  scene_type + " --scene_id 0" + room_id)
            os.system("python3 pipeline_InLoc_metric_level_ADA_RIO10-data_NETVLAD_ALL_idea6.py --scene_type " +  scene_type + " --scene_id 0" + room_id)

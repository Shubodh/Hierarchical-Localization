...
if __name__ == "__main__":
    ...
    netvlad_no = "40" # "100" # 
    loc_pairs = pairs / Path('netvlad'+netvlad_no +'_scene' + and_only_just + '_sampling10_' + date_netvlad +  '.txt') #netvlad40_FOR-scene01_and_places_sampling10_dt070322.txt  #netvlad40_FOR-scene01_only_places_dt070322.txt  # 'netvlad40_dt140222.txt' # top 40 retrieved by NetVLAD #-minustop3rooms

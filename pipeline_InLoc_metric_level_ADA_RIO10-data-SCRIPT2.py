...
loc_pairs = pairs / 'netvlad40_FOR-scene01_and_places_dt030322.txt'  # 'netvlad40_dt140222.txt' # top 40 retrieved by NetVLAD #-minustop3rooms

outputs = Path('/data/InLoc_dataset/outputs/rio/')  # where everything will be saved

# Set config
dt_time = 'dt030322-t1157'
feature_name  = 'd2net-ss'  # sift, superpoint_inloc, d2net-ss, netvlad
matcher_name  = 'NN-mutual' # NN-mutual, superglue
skip_no = 10

testing_type ='scene01_and_places_' #'scene01_'

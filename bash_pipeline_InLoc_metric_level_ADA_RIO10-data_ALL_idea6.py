...
if __name__ == '__main__':
    ...
    #scene_types_temp = [scene_types_aug_query[0]]
    ...
    for scene_type in scene_types_temp:
        ...
        for room_id in room_ids:
            ...
            print("python3 pipeline_InLoc_metric_level_ADA_RIO10-data_ALL_idea6.py --netvlad_no " + netvlad_no + " --scene_id 0" + room_id +" --scene_type " +scene_type+" --date "+dt + " --time "+ time)
            os.system("python3 pipeline_InLoc_metric_level_ADA_RIO10-data_ALL_idea6.py --netvlad_no " + netvlad_no + " --scene_id 0" + room_id +" --scene_type " +scene_type+" --date "+dt + " --time "+ time)

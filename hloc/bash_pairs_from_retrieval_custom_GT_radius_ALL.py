...
if __name__ == '__main__':
    ...
    for scene_type in current_scene_types:
        ...
        for room_id in room_ids:
            ...
            print("python3 pairs_from_retrieval_custom_GT_radius.py --room_id "+room_id+" --scene_type "+scene_type+" --num_matched "+ num_matched + " --output ../pairs/graphVPR/rio_metric/scene0"+room_id +"/netvlad"+num_matched+"_scene_GT_radius_"+scene_type +"_sampling10_"+dt + ".txt --query_prefix query/ --db_prefix database/cutouts/")
            os.system("python3 pairs_from_retrieval_custom_GT_radius.py --room_id "+room_id+" --scene_type "+scene_type+" --num_matched "+ num_matched + " --output ../pairs/graphVPR/rio_metric/scene0"+room_id +"/netvlad"+num_matched+"_scene_GT_radius_"+scene_type +"_sampling10_"+dt + ".txt --query_prefix query/ --db_prefix database/cutouts/")
